...
APACHE2_CONFIGURATION_OPTIONS = [
  ...
  },
  {
    ...
    :default_expr => 'DEFAULT_CONCURRENCY_MODEL',
  ...
  },
  {
    ...
    :htaccess_context => ['OR_ALL'],
    :min_value => 0,
    :default   => DEFAULT_APP_THREAD_COUNT,
    :default_expr => 'DEFAULT_APP_THREAD_COUNT',
  ...
  },
  {
    ...
    :htaccess_context => ['OR_ALL'],
    :min_value => 0,
    :default   => DEFAULT_MAX_REQUEST_QUEUE_TIME,
    :default_expr => 'DEFAULT_MAX_REQUEST_QUEUE_TIME',
