...
module PhusionPassenger
  module Standalone
    ...
    ADVANCED_CONFIG_SPECS = [
      {
        :name      => :defer_port_binding,
        :type      => :boolean,
        :desc      => "Defer binding the HTTP(S) port(s) until the app is booted"
      },
      {
        :name      => :start_timeout,
        :type      => :integer,
        :default   => 90,
        :desc      => 'Timeout starting apps after the given number of seconds. Default: %DEFAULT%'
      },
      {
