...
generate_config_manifest_for_autogenerated_loc_conf(manifest_gen_ctx_t *ctx, passenger_loc_conf_t *plcf, ngx_http_core_srv_conf_t *cscf, ngx_http_core_loc_conf_t *clcf) {
    ...
    if (plcf->autogenerated.max_instances_explicitly_set) {
        find_or_create_manifest_app_and_loc_options_containers(ctx,
            plcf, cscf, clcf, &app_options_container, &loc_options_container);
        option_container = find_or_create_manifest_option_container(ctx,
            app_options_container,
            "passenger_max_instances",
            sizeof("passenger_max_instances") - 1);
        hierarchy_member = add_manifest_option_container_hierarchy_member(option_container,
            &plcf->autogenerated.max_instances_source_file,
            plcf->autogenerated.max_instances_source_line);
        psg_json_value_set_int(hierarchy_member, "value",
            plcf->autogenerated.max_instances);
    }
    if (plcf->autogenerated.memory_limit_explicitly_set) {
        find_or_create_manifest_app_and_loc_options_containers(ctx,
            plcf, cscf, clcf, &app_options_container, &loc_options_container);
        option_container = find_or_create_manifest_option_container(ctx,
            app_options_container,
        ...
        hierarchy_member = add_manifest_option_container_hierarchy_member(option_container,
            &plcf->autogenerated.memory_limit_source_file,
            plcf->autogenerated.memory_limit_source_line);
        psg_json_value_set_int(hierarchy_member, "value",
            plcf->autogenerated.memory_limit);
    }
    if (plcf->autogenerated.concurrency_model_explicitly_set) {
        find_or_create_manifest_app_and_loc_options_containers(ctx,
            plcf, cscf, clcf, &app_options_container, &loc_options_container);
        option_container = find_or_create_manifest_option_container(ctx,
            app_options_container,
        ...
        hierarchy_member = add_manifest_option_container_hierarchy_member(option_container,
            &plcf->autogenerated.concurrency_model_source_file,
            plcf->autogenerated.concurrency_model_source_line);
        psg_json_value_set_str(hierarchy_member, "value",
            (const char *) plcf->autogenerated.concurrency_model.data,
            plcf->autogenerated.concurrency_model.len);
    }
    if (plcf->autogenerated.thread_count_explicitly_set) {
        find_or_create_manifest_app_and_loc_options_containers(ctx,
            plcf, cscf, clcf, &app_options_container, &loc_options_container);
        option_container = find_or_create_manifest_option_container(ctx,
            app_options_container,
        ...
        hierarchy_member = add_manifest_option_container_hierarchy_member(option_container,
            &plcf->autogenerated.thread_count_source_file,
            plcf->autogenerated.thread_count_source_line);
        psg_json_value_set_int(hierarchy_member, "value",
            plcf->autogenerated.thread_count);
    }
    if (plcf->autogenerated.rolling_restarts_explicitly_set) {
        find_or_create_manifest_app_and_loc_options_containers(ctx,
            plcf, cscf, clcf, &app_options_container, &loc_options_container);
        option_container = find_or_create_manifest_option_container(ctx,
            app_options_container,
        ...
        hierarchy_member = add_manifest_option_container_hierarchy_member(option_container,
            &plcf->autogenerated.rolling_restarts_source_file,
            plcf->autogenerated.rolling_restarts_source_line);
        psg_json_value_set_bool(hierarchy_member, "value",
            plcf->autogenerated.rolling_restarts);
    }
    if (plcf->autogenerated.resist_deployment_errors_explicitly_set) {
        find_or_create_manifest_app_and_loc_options_containers(ctx,
            plcf, cscf, clcf, &app_options_container, &loc_options_container);
        option_container = find_or_create_manifest_option_container(ctx,
            app_options_container,
        ...
        hierarchy_member = add_manifest_option_container_hierarchy_member(option_container,
            &plcf->autogenerated.resist_deployment_errors_source_file,
            plcf->autogenerated.resist_deployment_errors_source_line);
        psg_json_value_set_bool(hierarchy_member, "value",
            plcf->autogenerated.resist_deployment_errors);
    }
    if (plcf->autogenerated.max_request_time_explicitly_set) {
        find_or_create_manifest_app_and_loc_options_containers(ctx,
            plcf, cscf, clcf, &app_options_container, &loc_options_container);
        option_container = find_or_create_manifest_option_container(ctx,
            loc_options_container,
        ...
        hierarchy_member = add_manifest_option_container_hierarchy_member(option_container,
            &plcf->autogenerated.max_request_time_source_file,
            plcf->autogenerated.max_request_time_source_line);
        psg_json_value_set_int(hierarchy_member, "value",
            plcf->autogenerated.max_request_time);
    }
    if (plcf->autogenerated.max_request_queue_time_explicitly_set) {
        find_or_create_manifest_app_and_loc_options_containers(ctx,
            plcf, cscf, clcf, &app_options_container, &loc_options_container);
        option_container = find_or_create_manifest_option_container(ctx,
            loc_options_container,
        ...
        hierarchy_member = add_manifest_option_container_hierarchy_member(option_container,
            &plcf->autogenerated.max_request_queue_time_source_file,
            plcf->autogenerated.max_request_queue_time_source_line);
        psg_json_value_set_int(hierarchy_member, "value",
            plcf->autogenerated.max_request_queue_time);
    }
