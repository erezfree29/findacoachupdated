...
passenger_serialize_autogenerated_loc_conf_to_headers(ngx_conf_t *cf, passenger_loc_conf_t *conf) {
    ...
    if (conf->autogenerated.max_instances != NGX_CONF_UNSET) {
        end = ngx_snprintf(int_buf,
            sizeof(int_buf) - 1,
            "%d",
            conf->autogenerated.max_instances);
        len += sizeof("!~PASSENGER_MAX_PROCESSES: ") - 1;
        len += end - int_buf;
        len += sizeof("\r\n") - 1;
    }

    if (conf->autogenerated.memory_limit != NGX_CONF_UNSET) {
        end = ngx_snprintf(int_buf,
            sizeof(int_buf) - 1,
            "%d",
            conf->autogenerated.memory_limit);
        len += sizeof("!~PASSENGER_MEMORY_LIMIT: ") - 1;
        len += end - int_buf;
        len += sizeof("\r\n") - 1;
    }

    if (conf->autogenerated.concurrency_model.data != NULL) {
        len += sizeof("!~PASSENGER_CONCURRENCY_MODEL: ") - 1;
        len += conf->autogenerated.concurrency_model.len;
        len += sizeof("\r\n") - 1;
    }

    if (conf->autogenerated.thread_count != NGX_CONF_UNSET) {
        end = ngx_snprintf(int_buf,
            sizeof(int_buf) - 1,
            "%d",
            conf->autogenerated.thread_count);
        len += sizeof("!~PASSENGER_THREAD_COUNT: ") - 1;
        len += end - int_buf;
        len += sizeof("\r\n") - 1;
    }

    if (conf->autogenerated.rolling_restarts != NGX_CONF_UNSET) {
        len += sizeof("!~PASSENGER_ROLLING_RESTARTS: ") - 1;
        len += conf->autogenerated.rolling_restarts
            ? sizeof("t\r\n") - 1
            : sizeof("f\r\n") - 1;
    }

    if (conf->autogenerated.resist_deployment_errors != NGX_CONF_UNSET) {
        len += sizeof("!~PASSENGER_RESIST_DEPLOYMENT_ERRORS: ") - 1;
        len += conf->autogenerated.resist_deployment_errors
            ? sizeof("t\r\n") - 1
            : sizeof("f\r\n") - 1;
    }

    if (conf->autogenerated.max_request_time != NGX_CONF_UNSET) {
        end = ngx_snprintf(int_buf,
            sizeof(int_buf) - 1,
            "%d",
            conf->autogenerated.max_request_time);
        len += sizeof("!~PASSENGER_MAX_REQUEST_TIME: ") - 1;
        len += end - int_buf;
        len += sizeof("\r\n") - 1;
    }

    if (conf->autogenerated.max_request_queue_time != NGX_CONF_UNSET) {
        end = ngx_snprintf(int_buf,
            sizeof(int_buf) - 1,
            "%d",
            conf->autogenerated.max_request_queue_time);
    ...
    if (conf->autogenerated.concurrency_model.data != NULL) {
        ...
        pos = ngx_copy(pos,
            conf->autogenerated.concurrency_model.data,
            conf->autogenerated.concurrency_model.len);
        pos = ngx_copy(pos, (const u_char *) "\r\n", sizeof("\r\n") - 1);
    }
    if (conf->autogenerated.thread_count != NGX_CONF_UNSET) {
        pos = ngx_copy(pos,
    ...
    if (conf->autogenerated.rolling_restarts != NGX_CONF_UNSET) {
        ...
        if (conf->autogenerated.rolling_restarts) {
            pos = ngx_copy(pos, "t\r\n", sizeof("t\r\n") - 1);
        } else {
            pos = ngx_copy(pos, "f\r\n", sizeof("f\r\n") - 1);
        }
    ...
    if (conf->autogenerated.resist_deployment_errors != NGX_CONF_UNSET) {
        ...
        if (conf->autogenerated.resist_deployment_errors) {
            pos = ngx_copy(pos, "t\r\n", sizeof("t\r\n") - 1);
        } else {
            pos = ngx_copy(pos, "f\r\n", sizeof("f\r\n") - 1);
        }
