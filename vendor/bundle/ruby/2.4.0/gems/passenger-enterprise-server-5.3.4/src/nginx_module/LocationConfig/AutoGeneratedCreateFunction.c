...
passenger_create_autogenerated_loc_conf(passenger_autogenerated_loc_conf_t  *conf) {
    ...
    conf->max_instances_source_file.data = NULL;
    conf->max_instances_source_file.len = 0;
    conf->max_instances_source_line = 0;
    conf->max_instances_explicitly_set = 0;
    conf->memory_limit_source_file.data = NULL;
    conf->memory_limit_source_file.len = 0;
    conf->memory_limit_source_line = 0;
    conf->memory_limit_explicitly_set = 0;
    conf->concurrency_model_source_file.data = NULL;
    conf->concurrency_model_source_file.len = 0;
    conf->concurrency_model_source_line = 0;
    conf->concurrency_model_explicitly_set = 0;
    conf->thread_count_source_file.data = NULL;
    conf->thread_count_source_file.len = 0;
    conf->thread_count_source_line = 0;
    conf->thread_count_explicitly_set = 0;
    conf->rolling_restarts_source_file.data = NULL;
    conf->rolling_restarts_source_file.len = 0;
    conf->rolling_restarts_source_line = 0;
    conf->rolling_restarts_explicitly_set = 0;
    conf->resist_deployment_errors_source_file.data = NULL;
    conf->resist_deployment_errors_source_file.len = 0;
    conf->resist_deployment_errors_source_line = 0;
    conf->resist_deployment_errors_explicitly_set = 0;
    conf->max_request_time_source_file.data = NULL;
    conf->max_request_time_source_file.len = 0;
    conf->max_request_time_source_line = 0;
    conf->max_request_time_explicitly_set = 0;
    conf->max_request_queue_time_source_file.data = NULL;
    conf->max_request_queue_time_source_file.len = 0;
    conf->max_request_queue_time_source_line = 0;
    conf->max_request_queue_time_explicitly_set = 0;
