...
struct AutoGeneratedDirConfig {
	 ...
	 */
	Threeway mResistDeploymentErrors;

	/*
	 * Whether to turn on rolling restarts.
	 */
	Threeway mRollingRestarts;
	 ...
	 */
	StaticString mConcurrencyModel;
	...
	StaticString mDebuggerSourceFile;
	...
	StaticString mResistDeploymentErrorsSourceFile;
	StaticString mRollingRestartsSourceFile;
	...
	StaticString mConcurrencyModelSourceFile;
	...
	unsigned int mDebuggerSourceLine;
	...
	unsigned int mResistDeploymentErrorsSourceLine;
	unsigned int mRollingRestartsSourceLine;
	...
	unsigned int mConcurrencyModelSourceLine;
	...
	bool mResistDeploymentErrorsExplicitlySet: 1;
	bool mRollingRestartsExplicitlySet: 1;
	...
	bool mConcurrencyModelExplicitlySet: 1;
	...
	bool
	getDebugger() const {
		if (mDebugger == Apache2Module::UNSET) {
			return false;
		} else {
			return mDebugger == Apache2Module::ENABLED;
		}
	}
	...
	bool
	getResistDeploymentErrors() const {
		if (mResistDeploymentErrors == Apache2Module::UNSET) {
			return false;
		} else {
			return mResistDeploymentErrors == Apache2Module::ENABLED;
		}
	}

	bool
	getRollingRestarts() const {
		if (mRollingRestarts == Apache2Module::UNSET) {
			return false;
		} else {
			return mRollingRestarts == Apache2Module::ENABLED;
		}
	}
	...
	int
	getMaxInstances() const {
		if (mMaxInstances == UNSET_INT_VALUE) {
			return 0;
		} else {
	...
	int
	getMaxRequestQueueTime() const {
		if (mMaxRequestQueueTime == UNSET_INT_VALUE) {
			return DEFAULT_MAX_REQUEST_QUEUE_TIME;
		} else {
			return mMaxRequestQueueTime;
		}
	}

	int
	getMaxRequestTime() const {
		if (mMaxRequestTime == UNSET_INT_VALUE) {
			return 0;
		} else {
			return mMaxRequestTime;
		}
	}
	...
	getMemoryLimit() const {
		if (mMemoryLimit == UNSET_INT_VALUE) {
			return 0;
		} else {
			return mMemoryLimit;
		}
	...
	getThreadCount() const {
		if (mThreadCount == UNSET_INT_VALUE) {
			return DEFAULT_APP_THREAD_COUNT;
		} else {
			return mThreadCount;
		}
	}
	...
	StaticString
	getConcurrencyModel() const {
		if (mConcurrencyModel.empty()) {
			return DEFAULT_CONCURRENCY_MODEL;
		} else {
			return mConcurrencyModel;
		}
	}
