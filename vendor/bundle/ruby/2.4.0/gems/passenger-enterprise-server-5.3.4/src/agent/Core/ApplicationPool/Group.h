...
public:
	...
	/** Contains the spawn loop, restarter and requests timeout thread. */
	...
	void timeoutRequestsThread(GroupPtr self);
	...
	/****** Options changed signal for requests timeout thread ******/
