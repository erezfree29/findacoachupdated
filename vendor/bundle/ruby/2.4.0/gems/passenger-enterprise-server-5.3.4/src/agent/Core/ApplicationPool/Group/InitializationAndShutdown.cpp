...
Group::initialize() {
	...
	interruptableThreads.create_thread(boost::bind(&Group::timeoutRequestsThread, this, shared_from_this()),
			"timeoutRequestsThread: " + info.name, POOL_HELPER_THREAD_STACK_SIZE);
	return true;
}
